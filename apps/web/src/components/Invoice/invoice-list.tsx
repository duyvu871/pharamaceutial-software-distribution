...
export default function InvoiceDashboard({branchId}: {branchId: string}) {
				...
				<div className="flex-1 p-4 h-full flex flex-col">
					<div className="mb-6">
						<div className="flex justify-between items-center mb-4">
							<h1 className="text-xl font-medium">Hóa đơn</h1>
										...
										return (
											<>
												<Table.Tr key={invoice.id} h={50}>
													...
													<Table.Td onClick={() => toggleDetail(transformedInvoice)} className={'whitespace-nowrap'}>
														{transformedInvoice.debit.toLocaleString('vi-VN')}
													</Table.Td>
