...
interface SubscriptionCardProps {
	subscription: AdminType['admin_subsciption'][number];
	...
	return (
		<Card shadow="sm" padding="lg" radius="md" withBorder>
			<Flex justify="space-between" align="center" mb="sm">
				<Text size="lg" fw={500} >
					{subscription.admin_plans.plan_name}
				</Text>
				{getStatusBadge()}
			</Flex>
			<Stack gap="xs">
...
interface SubscriptionListProps {
	subscriptions: AdminType['admin_subsciption'];
	onCancel?: (id: string) => void;
}

const SubscriptionList: React.FC<SubscriptionListProps> = ({ subscriptions, onCancel }) => {
